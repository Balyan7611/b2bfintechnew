...
import { 
  FiSearch, FiFilter, FiCalendar, FiChevronLeft, FiChevronRight, FiCheckCircle, FiInfo, FiActivity, FiDatabase, FiAlertCircle, FiXCircle, FiWallet, FiPlusCircle
} from 'react-icons/fi';
import { 
    ...
    <div className={styles.container}>
      ...
      <div style={{ 
        ...
        <div style={{ padding: '12px 20px', borderBottom: '1px solid #F1F5F9', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px' }}>
          <h2 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 800, color: '#0F172A', letterSpacing: '0.2px' }}>Money Wallet Load History</h2>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '16px', alignItems: 'flex-end' }}>
              ...
              <div className={styles.formGroup}>
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <input type="text" placeholder="Order ID, Mobile..." className={styles.inputControl} style={{ height: '42px', width: '100%', paddingLeft: '35px', fontSize: '0.85rem', borderRadius: '10px', border: '1.5px solid #CBD5E1', outline: 'none', boxSizing: 'border-box' }} onFocus={(e) => e.target.style.borderColor = '#1756AA'} onBlur={(e) => e.target.style.borderColor = '#CBD5E1'} />
                </div>
              </div>
      ...
      <div className={styles.cardFullMobile}>
        <div className="global-table-toolbar">
          ...
          <div className="global-search-box">
            <FiSearch />
            <input type="text" placeholder="Search wallet logs..." />
          </div>
        </div>
        ...
        <div className={styles.tableWrapper}>
          <table className={styles.table} style={{ minWidth: '2200px' }}>
            ...
            <tbody>
              <tr>
                <td colSpan="17" style={{ textAlign: 'center', padding: '20px 0', color: '#A0AEC0' }}>
                   
                     <span style={{ fontSize: '0.9rem', fontWeight: 600, color: '#718096' }}>No wallet load history found</span></td>
              </tr>
            </tbody>
          </table>
        </div>
