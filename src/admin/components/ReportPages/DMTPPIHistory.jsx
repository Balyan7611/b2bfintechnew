...
import { 
  ...
  FiDatabase, FiAlertCircle, FiXCircle
} from 'react-icons/fi';
import { 
    ...
    <div className={styles.container} style={{ padding: '20px' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '15px', flexWrap: 'wrap', marginBottom: '16px' }}>
          <h3 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 800, color: '#0F172A', letterSpacing: '0.3px' }}>DMT PPI History</h3>
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: '12px', alignItems: 'flex-end' }}>
            ...
            <div className={styles.formGroup}>
              ...
              <select className={styles.inputControl} style={{ paddingLeft: '12px', paddingRight: '12px', height: '38px', borderRadius: '10px', fontSize: '0.825rem', border: focusedField === 'mode' ? '1.5px solid #1756AA' : '1.5px solid #CBD5E1', boxShadow: focusedField === 'mode' ? '0 0 0 3px rgba(23, 86, 170, 0.06)' : 'none', transition: 'all 0.25s', width: '100%', background: '#FCFDFE', color: '#334155', fontWeight: 500 }} onFocus={() => setFocusedField('mode')} onBlur={() => setFocusedField(null)}>
            ...
            <div className={styles.formGroup} style={{ gridColumn: 'span 2' }}>
              <label style={{ fontSize: '0.68rem', fontWeight: 700, letterSpacing: '0.5px', color: '#64748B', textTransform: 'uppercase', marginBottom: '2px', display: 'block' }}>Search Anything (Mobile, UTR, Trans ID)</label>
      ...
      <div className={styles.cardFullMobile} style={{ padding: 0, marginBottom: '100px' }}>
        ...
        <div className="global-table-toolbar" style={{ padding: '10px 15px' }}>
          ...
          <div className="global-search-box">
            <FiSearch />
            <input type="text" placeholder="Search PPI logs..." />
          </div>
        </div>
        ...
        <div className={styles.tableWrapper}>
          <table className={styles.table} style={{ minWidth: '3200px' }}>
            ...
            <tbody>
              <tr>
                <td colSpan="22" style={{ padding: '20px 0', color: '#A0AEC0', position: 'relative' }}>
                  
                    <span style={{ fontSize: '0.9rem', fontWeight: 600, color: '#718096' }}>No PPI records found</span></td>
              </tr>
            </tbody>
          </table>
        </div>
