      ...
      <div className={styles.cardFullMobile} style={{ padding: 0, marginBottom: '100px' }}>
        ...
        <div className={styles.tableWrapper}>
          <table className={styles.table} style={{ minWidth: '3800px' }}>
            ...
            <tbody>
              <tr>
                <td colSpan="31" style={{ padding: '20px 0', color: '#A0AEC0', position: 'relative' }}>
                   
                     <span style={{ fontSize: '0.9rem', fontWeight: 600, color: '#718096' }}>No recharge data found</span></td>
              </tr>
            </tbody>
          </table>
        </div>
