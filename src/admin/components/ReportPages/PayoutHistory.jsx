    ...
    <div className={styles.container} style={{ padding: '20px 24px', maxWidth: '100%' }}>
      ...
      <div style={{ 
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '16px', alignItems: 'flex-end' }}>
            ...
            <div className={styles.formGroup}>
              <label style={{ fontSize: '0.68rem', fontWeight: 700, letterSpacing: '0.5px', color: '#64748B', textTransform: 'uppercase', marginBottom: '2px', display: 'block' }}>Transfer Mode</label>
              <select 
                className={styles.inputControl} 
                style={{ 
                  paddingLeft: '12px', 
                  ...
                  borderRadius: '10px', 
                  fontSize: '0.825rem', 
                  border: focusedField === 'transferMode' ? '1.5px solid #1756AA' : '1.5px solid #CBD5E1', 
                  boxShadow: focusedField === 'transferMode' ? '0 0 0 3px rgba(23, 86, 170, 0.06)' : 'none', 
                  transition: 'all 0.25s', 
                  width: '100%', 
                  background: '#FCFDFE',
                  color: '#334155',
                ...
                onFocus={() => setFocusedField('transferMode')}
                onBlur={() => setFocusedField(null)}
              >
            ...
            <div className={styles.formGroup} style={{ gridColumn: 'span 2' }}>
              <label style={{ fontSize: '0.68rem', fontWeight: 700, letterSpacing: '0.5px', color: '#64748B', textTransform: 'uppercase', marginBottom: '2px', display: 'block' }}>Search Anything (Name, Order ID, RRN)</label>
      ...
      <div className={styles.cardFullMobile} style={{ padding: 0, marginBottom: '100px' }}>
        ...
        <div className="global-table-toolbar" style={{ padding: '10px 15px' }}>
          ...
          <ExportButtons headers={[]} rows={[]} fileNamePrefix="payouthistory_report" sheetName="Report" />

          <div className="global-search-box">
            <FiSearch />
            <input type="text" placeholder="Search payout logs..." />
          </div>
        </div>
        ...
        <div className={styles.tableWrapper}>
          <table className={styles.table} style={{ minWidth: '2000px' }}>
            ...
            <tbody>
              <tr>
                <td colSpan="15" style={{ padding: '20px 0', color: '#A0AEC0', position: 'relative' }}>
                   
                     <span style={{ fontSize: '0.9rem', fontWeight: 600, color: '#718096' }}>No payout data found</span></td>
              </tr>
            </tbody>
          </table>
        </div>
