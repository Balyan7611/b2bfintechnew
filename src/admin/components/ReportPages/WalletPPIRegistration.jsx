...
import { 
  FiSearch, FiFilter, FiCalendar, FiChevronLeft, FiChevronRight, FiCheckCircle, FiInfo, FiActivity, FiDatabase, FiAlertCircle, FiXCircle, FiUserPlus, FiGlobe
} from 'react-icons/fi';
import { 
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '16px', alignItems: 'flex-end' }}>
              ...
              <div className={styles.formGroup}>
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <input type="text" placeholder="Mobile, Merchant Code..." className={styles.inputControl} style={{ height: '42px', width: '100%', paddingLeft: '35px', fontSize: '0.85rem', borderRadius: '10px', border: '1.5px solid #CBD5E1', outline: 'none', boxSizing: 'border-box' }} onFocus={(e) => e.target.style.borderColor = '#1756AA'} onBlur={(e) => e.target.style.borderColor = '#CBD5E1'} />
                </div>
              </div>
      ...
      <div className={styles.cardFullMobile}>
        ...
        <div className={styles.tableWrapper}>
          <table className={styles.table} style={{ minWidth: '2200px' }}>
            ...
            <tbody>
              <tr>
                <td colSpan="14" style={{ textAlign: 'center', padding: '20px 0', color: '#A0AEC0' }}>
                   
                     <span style={{ fontSize: '0.9rem', fontWeight: 600, color: '#718096' }}>No registration data found</span></td>
              </tr>
            </tbody>
          </table>
        </div>
